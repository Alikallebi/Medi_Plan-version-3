    ...
    display_order = VALUES(display_order);";
        ...
        private async Task SeedRolesAsync(MySqlConnection connection)
        {
            ...
            var roles = new (string Id, string Name, string Type, string Color, string Icon, string Description, string? ParentId)[]
            {
                ...
                ("2", "CHEF_POLE", "system", "#10b981", "pi-sitemap", "Gestion du pôle et validation", null),
                ("3", "CHEF_SERVICE", "system", "#2563eb", "pi-user-edit", "Chef de service et gestion des plannings", null),
                ("4", "STAFF", "system", "#64748b", "pi-user", "Personnel médical standard", null)
            };
...
WHERE id = @id OR LOWER(role_name) = LOWER(@name);";
            ...
            var rolePermissions = new (string RoleName, string PermissionId, string Level)[]
            {
                ...
                // ── CHEF_POLE ─────────────────────────────────────────────
                ("CHEF_POLE",            "dashboard.view",            "read"),
                ("CHEF_POLE",            "planning.view",             "validate"),
                ("CHEF_POLE",            "personnel.view",            "read"),
                ("CHEF_POLE",            "workflow.soumissions",      "read"),
                ("CHEF_POLE",            "workflow.inbox",            "validate"),
                ("CHEF_POLE",            "referentiel.services",      "read"),
                ("CHEF_POLE",            "referentiel.equipes",       "read"),
                ("CHEF_POLE",            "referentiel.competences",   "read"),
                ("CHEF_POLE",            "referentiel.postes",        "read"),
                ("CHEF_POLE",            "planification.regles",      "read"),
                ("CHEF_POLE",            "admin.utilisateurs",        "read"),
                ("CHEF_POLE",            "admin.utilisateur-detail",  "read"),
                ("CHEF_POLE",            "outils.notifications",      "read"),
                ("CHEF_POLE",            "outils.historique",         "read"),
                ("CHEF_POLE",            "outils.rapports",           "read"),
                // ── CHEF_SERVICE ───────────────────────────────────────────
                ("CHEF_SERVICE",         "dashboard.view",            "read"),
                ("CHEF_SERVICE",         "planning.view",             "write"),
                ("CHEF_SERVICE",         "personnel.view",            "read"),
                ("CHEF_SERVICE",         "workflow.soumissions",      "write"),
                ("CHEF_SERVICE",         "workflow.inbox",            "validate"),
                ("CHEF_SERVICE",         "workflow.admin-dashboard",  "none"),
                ("CHEF_SERVICE",         "workflow.audit",            "none"),
                ("CHEF_SERVICE",         "referentiel.services",      "read"),
                ("CHEF_SERVICE",         "referentiel.equipes",       "read"),
                ("CHEF_SERVICE",         "referentiel.competences",   "read"),
                ("CHEF_SERVICE",         "referentiel.postes",        "read"),
                ("CHEF_SERVICE",         "planification.regles",      "read"),
                ("CHEF_SERVICE",         "admin.utilisateurs",        "read"),
                ("CHEF_SERVICE",         "admin.utilisateur-detail",  "read"),
                ("CHEF_SERVICE",         "admin.roles",               "none"),
                ("CHEF_SERVICE",         "outils.notifications",      "read"),
                ("CHEF_SERVICE",         "outils.historique",         "read"),
                ("CHEF_SERVICE",         "outils.rapports",           "read"),
                // ── STAFF ──────────────────────────────────────────────────
                ("STAFF",                 "dashboard.view",            "read"),
                ("STAFF",                 "planning.view",             "read"),
                ("STAFF",                 "outils.notifications",      "read"),
                // legacy names kept for compatibility with older exports
                ("Staff",                 "dashboard.view",            "read"),
                ("Staff",                 "planning.view",             "read"),
                ("Staff",                 "outils.notifications",      "read"),
            };
